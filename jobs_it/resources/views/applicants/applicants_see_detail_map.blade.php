            ...
            <div class="card" style="width: 80%; top:100px; height:auto">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group" style="float:right;">
                        <button type="submit" class="btn btn-warning" style="margin-left: 0px;" name="action_type" value="{{ $jobs->jobs_id }}" onclick="addmise(value);window.location.reload()">สนใจ</button>
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="jobs_type" value="{{$jobs->jobs_type}}">
                    </div>

                    <div class="form-group">
                        <label for="exampleFormControlSelect1">ประเภทการทำงาน</label>
                        <input readonly type="text" class="form-control" name="location_work" value="{{$jobs->location_work}}">
                    </div>
                    ...
                    <div class="form-group" style="float:right; margin-top:650px;">
                        <a href="{{ route('map') }}" class="btn btn-danger">กลับ</a>
                    </div>
                    @endif
                </div>
            </div>
