                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('applicants_delete_myjobs', $rows->myjobs_id) }}" method="post">
                                        <button class="btn btn-danger" onclick="window.location.reload();" type="submit" style="margin-top: 2px; width: 100%;">ลบ</button>
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('applicants_delete_myjobs_apply', $rows->myjobs_id) }}" method="post">
                                        <button class="btn btn-danger" onclick="window.location.reload();" type="submit" style="margin-top: 2px; width: 100%;">ลบ</button>
                                        @csrf
                                        @method('DELETE')
                                    </form>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('applicants_delete_myjobs_approve', $roves->myjobs_id) }}" method="post">
                                        <button class="btn btn-danger" onclick="window.location.reload();" type="submit" style="margin-top: 2px; width: 100%;">ลบ</button>
                                        @csrf
                                        @method('DELETE')
                                    </form>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('applicants_delete_myjobs_reject', $rejs->myjobs_id) }}" method="post">
                                        <button class="btn btn-danger" onclick="window.location.reload();" type="submit" style="margin-top: 2px; width: 100%;">ลบ</button>
                                        @csrf
                                        @method('DELETE')
                                    </form>
