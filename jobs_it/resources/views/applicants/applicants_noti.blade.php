...
<body>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="card" style="width: 80%; margin-top:100px; height:auto">
                <div class="card-header" style="background-color:#E94242; color:White;">
                    <p class="card-text" style="font-size: 18px;">รายละเอียดการสัมภาษณ์</p>
                </div>

                <div class="card-body">
                    <div class="form-group">
                        <!-- <label for="exampleFormControlTextarea1">รายละเอียดการสัมภาษณ์</label> -->
                        <textarea readonly class="form-control" name="message" id="exampleFormControlTextarea1" rows="8">{{ $all->message }}</textarea>
                    </div>
                </div>
            </div>

            <div class="card" style="width: 80%; margin-top:10px; height:auto">
                <div class="card-header" style="background-color:#E94242; color:White;">
