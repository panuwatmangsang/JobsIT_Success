        ...
        <div class="row justify-content-center">
            <div class="card" style="width: 80%;height:100%">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('applicants_delete_history', $history->history_id) }}" method="post">
                        ...
                        <!-- <div style="text-align:center;margin-top:40px;">
                            <span class="step" style="height: 15px; width: 15px; margin: 0 2px; background-color: red; border: none; border-radius: 50%; display: inline-block; opacity: 0.5;"></span>
                            <span class="step" style="height: 15px; width: 15px; margin: 0 2px; background-color: #bbbbbb; border: none; border-radius: 50%; display: inline-block; opacity: 0.5;"></span>
                            <span class="step" style="height: 15px; width: 15px; margin: 0 2px; background-color: #bbbbbb; border: none; border-radius: 50%; display: inline-block; opacity: 0.5;"></span>
                            <span class="step" style="height: 15px; width: 15px; margin: 0 2px; background-color: #bbbbbb; border: none; border-radius: 50%; display: inline-block; opacity: 0.5;"></span>
                            <span class="step" style="height: 15px; width: 15px; margin: 0 2px; background-color: #bbbbbb; border: none; border-radius: 50%; display: inline-block; opacity: 0.5;"></span>
                        </div> -->
                        ...
                        <form action="{{ route('applicants_delete_history', $history->history_id) }}" method="post">
                            <button class="btn btn-danger" onclick="return confirm('Are you sure?')" style="position: relative;top:38px" type="submit">ลบ</button>
                            @csrf
                            @method('DELETE')
                        </form>
                ...
                <div class="btn">
                    ...
                    <a href="{{ route('applicants_home') }}" class="btn btn-danger" style="float:right; margin-left:10px">กลับ</a>
                </div>
            </div>
        </div>
    </div>
