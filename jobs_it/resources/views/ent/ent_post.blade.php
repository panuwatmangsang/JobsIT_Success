                ...
                <div class="card-body">
                    <form action="{{ route('add_jobs') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jobs_name_company" placeholder="กรุณากรอกชื่อบริษัท" value="{{ old('jobs_name_company') }}">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="logo" accept="image/*" class="form-control-file" id="exampleFormControlFile1" value="{{ old('logo') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" name="jobs_name" placeholder="กรุณากรอกตำแหน่งงาน" value="{{ old('jobs_name') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="quantity">จำนวนที่ต้องการ</label>
                                <input type="text" class="form-control" name="jobs_quantity" placeholder="จำนวนที่ต้องการ" value="{{ old('jobs_quantity') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="quantity">จำนวนเงินเดือน</label>
                                <input type="text" class="form-control" name="jobs_salary" placeholder="เงินเดือน" value="{{ old('jobs_salary') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlSelect1">ประเภทของงาน</label>
                            <select class="form-control" name="jobs_type" id="exampleFormControlSelect1" value="{{ old('jobs_type') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="location_work" id="exampleFormControlSelect1" value="{{ old('location_work') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="jobs_detail" id="exampleFormControlTextarea1" rows="8" value="{{ old('jobs_detail') }}"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="nameCompany">ข้อมูลการติดต่อ</label>
                            <textarea class="form-control" name="jobs_contact" id="exampleFormControlTextarea1" rows="8" value="{{ old('jobs_contact') }}"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">ที่อยู่ของบริษัท</label>
                            <textarea class="form-control" name="jobs_address" id="exampleFormControlTextarea1" rows="8" value="{{ old('jobs_address') }}"></textarea>
