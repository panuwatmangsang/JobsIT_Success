            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('uploads/profile/'.$result['_source']['profile']) }}" alt="profile" width="100" height="100" style="float:left; border:black 1px solid;">

                        <div class="date" style="float: right;">

                            <br><br><br><br><br><br><br><br><br><br><br>

                            <button type="submit" class="btn btn-info" style="margin-left: 0px;" value="{{ $result['_source']['history_id'] }}" onclick="add(value);window.location.reload()">สนใจ</button>
