...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="card" style="width: 100%; margin-top:100px; height:auto">
                ...
                <div class="card-body">
                    <form action="{{ route('add_profile_company') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="profile_name_company" placeholder="กรุณากรอกชื่อบริษัท" value="{{ old('profile_name_company') }}">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="profile_logo" accept="image/*" class="form-control-file" id="exampleFormControlFile1" value="{{ old('profile_logo') }}"> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="profile_company_contact" placeholder="กรุณากรอกชื่อผู้ติดต่อ" value="{{ old('profile_company_contact') }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="quantity">เบอร์โทรศัพท์</label>
                                <input type="text" class="form-control" name="profile_company_phone" placeholder="เบอร์โทรศัพท์" value="{{ old('profile_company_phone') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="nameCompany">อีเมล</label>
                            <input type="text" class="form-control" name="profile_email" placeholder="กรุณากรอกอีเมล" value="{{ old('profile_email') }}">
                        </div>
                        ...
                        <div class="form-group" style="float:right; margin-top:400px;">
